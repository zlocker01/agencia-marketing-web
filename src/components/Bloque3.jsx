...
export const Bloque3 = () => {
  ...
  <h2 className="font-bold text-2xl text-principal">Somos tu Agencia ideal si...</h2>
  <ul className="py-5 mb-5 flex flex-col justify-center items-center gap-5">
    ...
    <li>
      ...
      </svg>Estás dispuesto a intentar cosas diferentes para lograr mejores
      resultados.
    </li>
    <li>
      <svg
      ...
      Has trabajado con otras agencias y no te dieron los resultados que esperabas.
    </li>
  </ul>
